...
$qry="INSERT INTO `fatwas`(`FatwaID`, `Sawal`, `Category`, `Image`) VALUES ('','$t2','$t3','$t1')";
$result=$con->query($qry);



echo "<script>alert('Apka Fatwa Mahfuze hoga han.! Shukria..')</script>"; 
}
...
<div class="panel-body" style="height: 380px; margin:0; padding:0; ">
 <form action="Fatwainsertion.php" method="post" enctype="multipart/form-data">
<table>

<tr>
<td><label id="bb"> Upload Pic of fatwa
    <input type="file" id="File" size="30" multiple    name="t1" required >
    </label></td>
    <td><label id="bb"> Sawal
