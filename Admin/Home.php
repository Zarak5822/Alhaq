...
<body>
    <div class="container">
        <div class="row mt-4">
            <div class="col-md-10">
           <a href="../index.php"> <img src="img/logo.jpg" class="logo rounded-circle" alt="logo"></a>
            </div>
            <div class="col-md-2">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row mt-5">
                ...
                <div class="card" style="width: 18rem;">
                <div class="card-body">
                    <h5 class="card-title">Announcement Insert</h5>
                    <p class="card-text"></p>
                    <a href="Announcements.php" class="btn btn-primary btn">Open</a>
                </div>
                </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"></p>
                    <a href="Applications.php" class="btn btn-primary btn">Open</a>
                </div>
                </div>
                </div>
